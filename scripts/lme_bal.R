...
# Coeficientes
write.csv(summary(modl3)$coefficients, file = '../data/output/balanced/mod_l3_fcoeff.csv')
write.csv(VarCorr(modl3), file = '../data/output/balanced/mod_l3_rcoeff.csv')
...
# df_train_balat <- read.csv('../data/treated/modelo/df_train_balat.csv')
# colnames(df_train)